...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			bufferTime: 20000, //缓存区的长度，单位：毫秒,不要小于100
			...
			volumeJump: 1, //音量调整的数量，大于0小于1的小数
		...
		*/
		...
		interFace: function() {
			...
			*/
			...
			html += '<div id="quxiaojying" class="' + escMuteID + '" data-title="' + thisTemp.language['escMute'] + '">' + this.newCanvas(escMuteID, bWidth, bHeight) + '</div>'; //退出静音按钮
