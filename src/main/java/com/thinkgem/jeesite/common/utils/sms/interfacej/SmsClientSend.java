package com.thinkgem.jeesite.common.utils.sms.interfacej;

import java.net.URLEncoder;

import com.thinkgem.jeesite.common.utils.sms.tool.SmsClientAccessTool;
...
public class SmsClientSend {
	...
	public static String url = "http://106.3.37.99:7799/sms.aspx";
	public static String userid = "606";
	public static String account = "dskj";
...
//	public static String checkWord = "这个字符串中是否包含了屏蔽字";
	...
	public static void main(String[] args) {
		try {
			String s = SmsClientSend.sendSms("17783689928", "【返现商城】陪练网站注册验证：655455（10分钟内有效，如您已成功注册，请忽略此条信息）");
	...
	public static String sendSms(String mobile, String content) {
		return sendSms(SmsClientSend.url, SmsClientSend.userid, SmsClientSend.account, SmsClientSend.password, 
				mobile, content, null, null, null, null, null, null, null, "POST", "UTF-8", "UTF-8");
	}
